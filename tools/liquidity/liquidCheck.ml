  ...
  and typecheck_prim1 prim loc args =
    ...
    | _ ->
       let prim =
         ...
         match prim, args with
         | "update", [ _; _; { ty = Tset _ }] -> "Set.update"
         | "update", [ _; _; { ty = Tmap _ }] -> "Map.update"
         | "mem", [ _; { ty = Tset _ } ] -> "Set.mem"
         | "mem", [ _; { ty = Tmap _ } ] -> "Map.mem"
         | "find", [ _; { ty = Tmap _ } ] -> "Map.find"
         | "map", [ _; { ty = Tlist _ } ] -> "List.map"
