...
clone-tezos:
	git clone -b zeronet https://gitlab.com/tezos/tezos.git # clone with https
...
MORE_TESTS=test_ifcons test_if test_loop test_option test_transfer test_left \
  ...
  test_fold test_iter test_big_map test_map_fold_closure
